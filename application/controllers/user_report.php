...
class user_report extends CI_Controller
{
	...
	function index()
	{
		...
		if(!$report)
		{
			...
			$this->load->view('main/view_reports',$data);
		...
		else 
		{
			...
			$objPHPExcel->getActiveSheet()->getStyle('E2')->applyFromArray( array( 'alignment' => $align_center,'font' => $fontstyle1 ) );
			$objPHPExcel->getActiveSheet()->getStyle('F2')->applyFromArray( array( 'alignment' => $align_center,'font' => $fontstyle1 ) );
			$objPHPExcel->getActiveSheet()->getStyle('G2')->applyFromArray( array( 'alignment' => $align_center,'font' => $fontstyle1 ) );
			$objPHPExcel->getActiveSheet()->getStyle('H2')->applyFromArray( array( 'alignment' => $align_center,'font' => $fontstyle1 ) );
			$objPHPExcel->getActiveSheet()->getStyle('I2')->applyFromArray( array( 'alignment' => $align_center,'font' => $fontstyle1 ) );
			$objPHPExcel->getActiveSheet()->getStyle('J2')->applyFromArray( array( 'alignment' => $align_center,'font' => $fontstyle1 ) );
			$objPHPExcel->getActiveSheet()->getStyle('K2')->applyFromArray( array( 'alignment' => $align_center,'font' => $fontstyle1 ) );
			$objPHPExcel->getActiveSheet()->getStyle('L2')->applyFromArray( array( 'alignment' => $align_center,'font' => $fontstyle1 ) );
			$objPHPExcel->getActiveSheet()->getStyle('M2')->applyFromArray( array( 'alignment' => $align_center,'font' => $fontstyle1 ) );
			$objPHPExcel->getActiveSheet()->getStyle('N2')->applyFromArray( array( 'alignment' => $align_center,'font' => $fontstyle1 ) );
			$objPHPExcel->getActiveSheet()->getStyle('O2')->applyFromArray( array( 'alignment' => $align_center,'font' => $fontstyle1 ) );
			$objPHPExcel->getActiveSheet()->getStyle('P2')->applyFromArray( array( 'alignment' => $align_center,'font' => $fontstyle1 ) );
			$objPHPExcel->getActiveSheet()->getStyle('Q2')->applyFromArray( array( 'alignment' => $align_center,'font' => $fontstyle1 ) );
			$objPHPExcel->getActiveSheet()->getStyle('R2')->applyFromArray( array( 'alignment' => $align_center,'font' => $fontstyle1 ) );
			$objPHPExcel->getActiveSheet()->getStyle('S2')->applyFromArray( array( 'alignment' => $align_center,'font' => $fontstyle1 ) );
			$objPHPExcel->getActiveSheet()->getStyle('T2')->applyFromArray( array( 'alignment' => $align_center,'font' => $fontstyle1 ) );
			$objPHPExcel->getActiveSheet()->getStyle('U2')->applyFromArray( array( 'alignment' => $align_center,'font' => $fontstyle1 ) );
			$objPHPExcel->getActiveSheet()->getStyle('V2')->applyFromArray( array( 'alignment' => $align_center,'font' => $fontstyle1 ) );
			//Set column width
...
// 					$objPHPExcel->getActiveSheet()->getStyle('Q2:Q10000')->getNumberFormat()->setFormatCode('YYYY-MM-DD');
			...
			$objPHPExcel->getActiveSheet()->SetCellValue('R2','WEEKNUM');
			$objPHPExcel->getActiveSheet()->SetCellValue('S2','WEEKYEAR');
			//contents
			...
			foreach ($timesheets_report as $ts_report)
			{
				...
				$objPHPExcel->getActiveSheet()->SetCellValue('R'.$a,$ts_report->weeknum);
				$objPHPExcel->getActiveSheet()->SetCellValue('S'.$a,$ts_report->weekyear);
				$a=$a+1;
			}
			$a=$a-1;
			...
			$objPHPExcel->getActiveSheet()->getStyle("R2:R".$a)->applyFromArray($styleArray2);
			$objPHPExcel->getActiveSheet()->getStyle("S2:S".$a)->applyFromArray($styleArray2); 
			$objPHPExcel->getActiveSheet()->setTitle("TIMESHEET");
			// 		$objPHPExcel = new PHPExcel();
