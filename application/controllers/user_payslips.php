...
Autoloader::register();
Settings::loadConfig();
class user_payslips extends CI_Controller {
...
// 		 }
		...
		$config['base_url'] = base_url('user_payslips/index/');
		...
		$this->load->view('main/view_payslips',$data);
...
// 		}
		...
		$this->load->library('pagination');
		$config['base_url'] = base_url('user_payslips/view_payslip_search/');
		$config['total_rows'] = $total_row->count_payslips;
		...
		$data['user_picture'] = substr($this->session->userdata('user_picture'), 1);
		$this->load->view('header/header_main',$data);
		$this->load->view('main/view_payslips_search',$data);
		$this->load->view('footer/footer_main',$data);
	}
...
// echo $get_current_weeknr["StartDate"];
		...
		$data['emp_no'] = $get_top_emp_no->emp_no;
...
// 		$data['post_month'] = "";
		...
		$data['user_picture'] = substr($this->session->userdata('user_picture'), 1);
		$this->load->view('header/header_main',$data);
		$this->load->view('main/user_add_timesheets',$data);
		$this->load->view('footer/footer_main',$data);
	}
...
// 		$total_deduction = var_dump($view_deduction);
	...
	public function print_payslip()
	{
		...
		$file_name= "";		
// 		$ts_emp_no 	= '1046';
// 		$wk_start_date 	= '20180402';
// 		$wk_end_date 	='20180408';
