									...
									<?php if(count($allowance)>0):?>
											<?php foreach ($allowance as $allowance):?>
												<tr>
													...
													<td>
														<a href="<?=base_url('allowance/update_allowance/'.encode($allowance->Allowance_ID));?>" title="edit"><i class="fa fa-fw fa-edit"></i></a>|
														<a href="<?=base_url('allowance/delete_allowance/'.encode($allowance->Allowance_ID));?>" title="delete"><i class="fa fa-fw fa-trash-o"></i></a>
													</td>
												</tr>
											<?php endforeach;?>
										<?php else:?>
