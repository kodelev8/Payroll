								...
								<div class="col-xs-6">
									<div id="example1_length" class="dataTables_length">
										...
										<?php if($employee_count>10):?>
											<?= form_open('employee/view_employee_scan/', array('id' => 'frm_emp_view', 'class'=>'form-horizontal')); ?>
												<select name="emp_per_page" id="emp_per_page" size="1" aria-controls="example1">
