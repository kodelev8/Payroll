									...
									<div id="example1_length" class="dataTables_length">
										<label>
											<?php if($leave_count>10):?>
												<?= form_open('leave/view_leave_searched/', array('id' => 'frm_leave_searched', 'class'=>'form-horizontal')); ?>
													<select name="leave_per_page_search" id="leave_per_page_search" size="1" aria-controls="example1">
