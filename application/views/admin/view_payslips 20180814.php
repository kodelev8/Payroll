									...
									<div id="example1_length" class="dataTables_length">
										<label> 
											<?php if(count($payslips_num_rows)>10):?>
												<?= form_open('payslips/view_payslip_scan/', array('id' => 'frm_payslip_view', 'class'=>'form-horizontal')); ?>
							...
							<table id="example" class="table table-bordered table-striped">
								<thead>
									<tr>
										...
										<th><a href="<?=base_url('payslips/index/0/Ps_Emp_Name');?>" class="a_sort">Emp Name</a></th>
										<th><a href="<?=base_url('payslips/index/0/Ps_Base_Pay');?>" class="a_sort">Base Pay</a></th>
										<th><a href="<?=base_url('payslips/index/0/Ps_OT_Pay');?>" class="a_sort">OT Pay</a></th>
										<th><a href="<?=base_url('payslips/index/0/Ps_Night_OT_Pay');?>" class="a_sort">Night OT Pay</a></th>
										<th><a href="<?=base_url('payslips/index/0/Ps_Total_Pay');?>" class="a_sort">Total Pay</a></th>
										<th><a href="<?=base_url('payslips/index/0/Ps_Sub');?>" class="a_sort">Sub</a></th>
										<th><a href="<?=base_url('payslips/index/0/Ps_Add');?>" class="a_sort">Add</a></th>
										<th><a href="<?=base_url('payslips/index/0/Ps_Date_From');?>" class="a_sort">Date From</a></th>
										<th><a href="<?=base_url('payslips/index/0/Ps_Date_To');?>" class="a_sort">Date To</a></th>
										<th>Action</th>
									</tr>
								</thead>
								<tbody>
