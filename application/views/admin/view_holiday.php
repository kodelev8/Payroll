									...
									<div id="example1_length" class="dataTables_length">
										<label>
											<?php if($holiday_count>10):?>
												<?= form_open('holiday/view_holiday_scan/', array('id' => 'frm_holiday_view', 'class'=>'form-horizontal')); ?>
													<select name="holiday_per_page" id="holiday_per_page" size="1" aria-controls="example1">
