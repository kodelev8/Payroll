	...
	<div class="content-wrapper">
		...
		<section class="content-header">
			...
			<ol class="breadcrumb">
				...
				<li><a href="#">Employee Deduction</a></li>
				...
				<div class="col-xs-12">
					<div class="box box-primary">
						<div class="box-header">
							<h3 class="box-title">Employee Deduction <?=$deduction_action; ?></h3>
						</div><!-- /.box-header -->
								...
								<div class="col-md-4">
									<table class="table ">
										<tr>
											<td></td>
											<td>Employee Name:</td>
											<td><?=$deduction_info->Deduction_Emp_Name;?></td>
										</tr>
										<tr>
											<td></td>
											<td>Amount of Deduction:</td>
											<td><?=$deduction_info->Deduction_Amount;?></td>
										</tr>
										<tr>
											<td></td>
											<td>Description of Deduction:</td>
											<td><?=$deduction_info->Deduction_Description;?></td>
										</tr>
										<tr>
											<td></td>
											<td>Date of Deduction:</td>
											<td><?=date('Y-m-d',strtotime($deduction_info->Deduction_Date));?></td>
										</tr> 
									</table>
								</div><!-- /.col -->
							</div><!-- /.row -->
