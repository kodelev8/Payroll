							...
							<div class="row">
								<div class="col-xs-6">
									<div id="example1_length" class="dataTables_length">
										<label>
											<?= form_open('dtr/view_dtr_searched/', array('id' => 'frm_dtr_searched', 'class'=>'form-horizontal')); ?>
												<select name="dtr_per_page_search" id="dtr_per_page_search" size="1" aria-controls="example1">
								...
								<div class="col-xs-6">
									<div id="example1_filter" class="dataTables_filter">
										<label>
										Search: <input type="text" name="dtr_search" id="dtr_search" aria-controls="example1" value="">
										</label>
									</div>
								</div>
							</div>
