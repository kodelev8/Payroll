			...
			<div class="row">
				<div class="col-xs-12">
					<div class="box box-primary">
						...
						<div class="row">
							<div class="col-md-6">
								<?=form_open_multipart('employee/update_employee/'.encode($emp_user_id), array('id' => 'index', 'class'=>'form-horizontal')); ?>
								<div class="box-body">
									<?php 
									...
									<?php 
										...
										echo bs_inputfield_id('Employee Wages: ',				'emp_wages', 				element('emp_wages',			$record), true);
									?>
							...
							<div class="col-md-4">
								<div class="box box-primary">
									<div class="box-body box-profile">
										<center> 
												<?php 
													if(count($record["emp_pic"])> 0)
													{
														$emp_pic = '/pictures/thumb_'.substr($record["emp_pic"], 11); 
													}
													else 
													{
														$emp_pic = '/pictures/thumb_default.png';
													}     
												?>
											<img class="profile-user-img img-responsive img-circle" id="image_emp" src="<?=base_url('images').$emp_pic;?>" alt="User profile picture">
										</center>   
									</div> 
								</div> 
							</div>
