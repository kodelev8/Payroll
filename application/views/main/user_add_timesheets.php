			...
			<div class="row">
				<div class="col-xs-12">
					<div class="box box-primary">
						...
						<h3 class="box-title">Add Employee Payslips</h3>
						</div><!-- /.box-header -->
									...
									<div class="col-md-1">
										<select name="emp_number" id="emp_number" class="form-control" onchange="show_emp_number();">
											<?php foreach($get_employees as $user):?>
												<option value="<?=$user->emp_no;?>"<?= $user->emp_no == $emp_no ? 'selected="selected"': ''; ?>><?= $user->emp_no;?></option>
											<?php endforeach; ?>  	
										</select>
									</div>
									<div class="col-md-1" style="width:150px;">
									...
									<div class="col-md-6">
										...
										<div class="row" style="margin-left:5px;"> <br>
											...
											<div class="row" id="row_day_8" hidden="">
												...
												<div class="col-md-1" style="width:15%;">
													<input class="timepicker form-control" type="text" id="day_login_8" 	value="07:00 AM"> 
												</div>
												<div class="col-md-1" style="width:15%;">
											...
											<div class="row" id="row_day_9" hidden="">
												...
												<div class="col-md-1" style="width:15%;">
													<input class="timepicker form-control" type="text" id="day_login_9" 	value="07:00 AM"> 
												</div>
												<div class="col-md-1" style="width:15%;">
											...
											<div class="row" id="row_day_10" hidden="">
												...
												<div class="col-md-1" style="width:15%;">
													<input class="timepicker form-control" type="text" id="day_login_10" 	value="07:00 AM"> 
												</div>
												<div class="col-md-1" style="width:15%;">
											...
											<div class="row" id="row_day_11" hidden="">
												...
												<div class="col-md-1" style="width:15%;">
													<input class="timepicker form-control" type="text" id="day_login_11" 	value="07:00 AM"> 
												</div>
												<div class="col-md-1" style="width:15%;">
											...
											<div class="row" id="row_day_12" hidden="">
												...
												<div class="col-md-1" style="width:15%;">
													<input class="timepicker form-control" type="text" id="day_login_12" 	value="07:00 AM"> 
												</div>
												<div class="col-md-1" style="width:15%;">
											...
											<div class="row" id="row_day_13" hidden="">
												...
												<div class="col-md-1" style="width:15%;">
													<input class="timepicker form-control" type="text" id="day_login_13" 	value="07:00 AM"> 
												</div>
												<div class="col-md-1" style="width:15%;">
											...
											<div class="row" id="row_day_14" hidden="">
												...
												<div class="col-md-1" style="width:15%;">
													<input class="timepicker form-control" type="text" id="day_login_14" 	value="07:00 AM"> 
												</div>
												<div class="col-md-1" style="width:15%;">
											...
											<div class="box-body box-profile">
												...
												<ul class="list-group list-group-unbordered">
													<li class="list-group-item">
														<b>Employee Numer</b> <b id="emp_no" class="pull-right"></b>
													</li>
													<li class="list-group-item">
							...
							<div class="box-footer">
								...
								<button type="submit"  class="btn btn-primary" id="btn-print" name="btn-add" value="add" onclick="print_payslip()" disabled> SAVE PAYSLIPS <i class="fa fa-save" style="font-size:20px;"></i></button>
