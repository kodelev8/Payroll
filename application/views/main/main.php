				...
				<div class="box box-solid bg-blue-biscay">
					<div class="box-header with-border">
						...
						<div class="box-tools pull-right">
							...
							<button class="btn btn-primary btn-sm pull-right" style="margin-right: 5px;" data-toggle="tooltip"  data-original-title="Manual_DTR" onclick="location.href='<?=base_url('dtrms/dtr_manual');?>';">
					...
					<div class="box-body">
						<div class="row">
							...
							<div class="col-md-3">
								...
								<?= form_open('dtrms/dtr_log', array('class' => 'form-horizontal')); ?>
									<input class="text-center input-lg" id="emp_id" name="dtr_emp_id" maxlength="3" type="text" disabled="disabled" autocomplete="off" required>
									<p></p>
