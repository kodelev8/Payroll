				...
				<div class="col-md-10">
					...
					<div class="box-header with-border">
						...
						<div class="box-tools pull-right">
							...
							<button class="btn btn-primary btn-sm pull-right" style="margin-right: 5px;" data-toggle="tooltip"  data-original-title="Main" onclick="location.href='<?=base_url('dtrms') ;?>';">
					...
					<div class="box-body" id="summary_tbl">
						...
						<div class="row">
							...
							<div class="col-md-12">
								...
								<?= form_open('dtrms/update_daily_task/'.encode($record['dt_id']), array('id' => 'index', 'class'=>'form-horizontal')); ?>
								...
								<div class="box-footer">
									<div class="form-actions" style="color:#333;">
										...
										<button type="submit"  class="btn btn-primary" name="btn-add" value="add">Update Daily Task</button>
										<a href="<?=base_url('dtrms/main_daily_task/'.encode($record['dt_emp_no']).'/'.encode($record['dt_date']));?>" class="btn btn-primary">Cancel</a>
									</div>
								</div>
